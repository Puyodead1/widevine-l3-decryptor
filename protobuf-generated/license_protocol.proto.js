...
LicenseIdentification.read = function (pbf, end) {
  return pbf.readFields(
    LicenseIdentification._readField,
    {
      request_id: null,
      session_id: null,
      purchase_id: null,
...
LicenseIdentification.write = function (obj, pbf) {
  ...
  if (obj.provider_session_token)
    pbf.writeBytesField(6, obj.provider_session_token);
};
...
License._readField = function (tag, obj, pbf) {
  if (tag === 1)
    obj.id = LicenseIdentification.read(pbf, pbf.readVarint() + pbf.pos);
  else if (tag === 2)
    obj.policy = License.Policy.read(pbf, pbf.readVarint() + pbf.pos);
  else if (tag === 3)
    obj.key.push(License.KeyContainer.read(pbf, pbf.readVarint() + pbf.pos));
...
License.write = function (obj, pbf) {
  ...
  if (obj.key)
    for (var i = 0; i < obj.key.length; i++)
      pbf.writeMessage(3, License.KeyContainer.write, obj.key[i]);
  if (obj.license_start_time) pbf.writeVarintField(4, obj.license_start_time);
  if (obj.remote_attestation_verified)
    pbf.writeBooleanField(5, obj.remote_attestation_verified);
  if (obj.provider_client_token)
    pbf.writeBytesField(6, obj.provider_client_token);
};
...
License.Policy._readField = function (tag, obj, pbf) {
  if (tag === 1) obj.can_play = pbf.readBoolean();
    ...
    obj.renewal_recovery_duration_seconds = pbf.readVarint(true);
  else if (tag === 8) obj.renewal_server_url = pbf.readString();
  else if (tag === 9) obj.renewal_delay_seconds = pbf.readVarint(true);
  else if (tag === 10)
    obj.renewal_retry_interval_seconds = pbf.readVarint(true);
...
License.Policy.write = function (obj, pbf) {
  ...
  if (obj.rental_duration_seconds)
    pbf.writeVarintField(4, obj.rental_duration_seconds);
  if (obj.playback_duration_seconds)
    pbf.writeVarintField(5, obj.playback_duration_seconds);
  if (obj.license_duration_seconds)
    pbf.writeVarintField(6, obj.license_duration_seconds);
  if (obj.renewal_recovery_duration_seconds)
  ...
  if (obj.renewal_delay_seconds)
    pbf.writeVarintField(9, obj.renewal_delay_seconds);
  if (obj.renewal_retry_interval_seconds)
    pbf.writeVarintField(10, obj.renewal_retry_interval_seconds);
  if (obj.renew_with_usage) pbf.writeBooleanField(11, obj.renew_with_usage);
  if (obj.renew_with_client_id)
    pbf.writeBooleanField(12, obj.renew_with_client_id);
};
...
License.KeyContainer.read = function (pbf, end) {
  return pbf.readFields(
    License.KeyContainer._readField,
    {
      id: null,
      iv: null,
      key: null,
      type: 0,
      level: { value: 1, options: {} },
      required_protection: null,
      requested_protection: null,
      key_control: null,
      operator_session_key_permissions: null,
...
License.KeyContainer._readField = function (tag, obj, pbf) {
  if (tag === 1) obj.id = pbf.readBytes();
    ...
    obj.required_protection = License.KeyContainer.OutputProtection.read(
      pbf,
      pbf.readVarint() + pbf.pos
    );
  else if (tag === 7)
    obj.requested_protection = License.KeyContainer.OutputProtection.read(
      pbf,
      pbf.readVarint() + pbf.pos
    );
  else if (tag === 8)
    obj.key_control = License.KeyContainer.KeyControl.read(
      pbf,
      pbf.readVarint() + pbf.pos
    );
  else if (tag === 9)
    obj.operator_session_key_permissions = License.KeyContainer.OperatorSessionKeyPermissions.read(
      pbf,
      pbf.readVarint() + pbf.pos
    );
  else if (tag === 10)
    obj.video_resolution_constraints.push(
      License.KeyContainer.VideoResolutionConstraint.read(
        pbf,
        pbf.readVarint() + pbf.pos
      )
    );
...
License.KeyContainer.write = function (obj, pbf) {
  ...
  if (obj.type) pbf.writeVarintField(4, obj.type);
  if (obj.level != undefined && obj.level !== { value: 1, options: {} })
    pbf.writeVarintField(5, obj.level);
  if (obj.required_protection)
    pbf.writeMessage(
      6,
      License.KeyContainer.OutputProtection.write,
      obj.required_protection
    );
  if (obj.requested_protection)
    pbf.writeMessage(
      7,
      License.KeyContainer.OutputProtection.write,
      obj.requested_protection
    );
  if (obj.key_control)
    pbf.writeMessage(8, License.KeyContainer.KeyControl.write, obj.key_control);
  if (obj.operator_session_key_permissions)
    pbf.writeMessage(
      9,
      License.KeyContainer.OperatorSessionKeyPermissions.write,
      obj.operator_session_key_permissions
    );
  if (obj.video_resolution_constraints)
    for (var i = 0; i < obj.video_resolution_constraints.length; i++)
      pbf.writeMessage(
        10,
        License.KeyContainer.VideoResolutionConstraint.write,
        obj.video_resolution_constraints[i]
      );
...
License.KeyContainer.KeyControl.read = function (pbf, end) {
  return pbf.readFields(
    License.KeyContainer.KeyControl._readField,
    { key_control_block: null, iv: null },
    end
  );
};
...
License.KeyContainer.OutputProtection.read = function (pbf, end) {
  return pbf.readFields(
    License.KeyContainer.OutputProtection._readField,
    { hdcp: { value: 0, options: {} }, cgms_flags: { value: 42, options: {} } },
    end
  );
};
...
License.KeyContainer.OutputProtection.write = function (obj, pbf) {
  if (obj.hdcp != undefined && obj.hdcp !== { value: 0, options: {} })
    pbf.writeVarintField(1, obj.hdcp);
  if (
    obj.cgms_flags != undefined &&
    obj.cgms_flags !== { value: 42, options: {} }
  )
    pbf.writeVarintField(2, obj.cgms_flags);
};
...
License.KeyContainer.VideoResolutionConstraint.read = function (pbf, end) {
  return pbf.readFields(
    License.KeyContainer.VideoResolutionConstraint._readField,
    {
      min_resolution_pixels: 0,
      max_resolution_pixels: 0,
      required_protection: null,
    },
    end
  );
};
License.KeyContainer.VideoResolutionConstraint._readField = function (
  tag,
  obj,
  pbf
) {
...
License.KeyContainer.VideoResolutionConstraint.write = function (obj, pbf) {
  if (obj.min_resolution_pixels)
    pbf.writeVarintField(1, obj.min_resolution_pixels);
  if (obj.max_resolution_pixels)
    pbf.writeVarintField(2, obj.max_resolution_pixels);
  if (obj.required_protection)
    pbf.writeMessage(
      3,
      License.KeyContainer.OutputProtection.write,
...
License.KeyContainer.OperatorSessionKeyPermissions.read = function (pbf, end) {
  return pbf.readFields(
    License.KeyContainer.OperatorSessionKeyPermissions._readField,
    {
      allow_encrypt: false,
      allow_decrypt: false,
      allow_sign: false,
      allow_signature_verify: false,
    },
    end
  );
};
License.KeyContainer.OperatorSessionKeyPermissions._readField = function (
  tag,
  obj,
  pbf
) {
...
License.KeyContainer.OperatorSessionKeyPermissions.write = function (obj, pbf) {
  ...
  if (obj.allow_signature_verify)
    pbf.writeBooleanField(4, obj.allow_signature_verify);
};
...
LicenseRequest.read = function (pbf, end) {
  return pbf.readFields(
    LicenseRequest._readField,
    {
      client_id: null,
      content_id: null,
      type: 0,
      request_time: 0,
      key_control_nonce_deprecated: null,
      protocol_version: { value: 20, options: {} },
      key_control_nonce: 0,
...
LicenseRequest._readField = function (tag, obj, pbf) {
  if (tag === 1)
    obj.client_id = ClientIdentification.read(pbf, pbf.readVarint() + pbf.pos);
  else if (tag === 2)
    obj.content_id = LicenseRequest.ContentIdentification.read(
      pbf,
      pbf.readVarint() + pbf.pos
    );
    ...
    obj.encrypted_client_id = EncryptedClientIdentification.read(
      pbf,
      pbf.readVarint() + pbf.pos
    );
};
LicenseRequest.write = function (obj, pbf) {
  if (obj.client_id)
    pbf.writeMessage(1, ClientIdentification.write, obj.client_id);
  if (obj.content_id)
    pbf.writeMessage(
      2,
      LicenseRequest.ContentIdentification.write,
      obj.content_id
    );
  if (obj.type) pbf.writeVarintField(3, obj.type);
  if (obj.request_time) pbf.writeVarintField(4, obj.request_time);
  if (obj.key_control_nonce_deprecated)
    pbf.writeBytesField(5, obj.key_control_nonce_deprecated);
  if (
    obj.protocol_version != undefined &&
    obj.protocol_version !== { value: 20, options: {} }
  )
    pbf.writeVarintField(6, obj.protocol_version);
  if (obj.key_control_nonce) pbf.writeVarintField(7, obj.key_control_nonce);
  if (obj.encrypted_client_id)
    pbf.writeMessage(
      8,
      EncryptedClientIdentification.write,
      obj.encrypted_client_id
    );
};
...
LicenseRequest.ContentIdentification.read = function (pbf, end) {
  return pbf.readFields(
    LicenseRequest.ContentIdentification._readField,
    { cenc_id: null, webm_id: null, license: null },
    end
  );
};
LicenseRequest.ContentIdentification._readField = function (tag, obj, pbf) {
  if (tag === 1)
    obj.cenc_id = LicenseRequest.ContentIdentification.CENC.read(
      pbf,
      pbf.readVarint() + pbf.pos
    );
  else if (tag === 2)
    obj.webm_id = LicenseRequest.ContentIdentification.WebM.read(
      pbf,
      pbf.readVarint() + pbf.pos
    );
  else if (tag === 3)
    obj.license = LicenseRequest.ContentIdentification.ExistingLicense.read(
      pbf,
      pbf.readVarint() + pbf.pos
    );
};
LicenseRequest.ContentIdentification.write = function (obj, pbf) {
  if (obj.cenc_id)
    pbf.writeMessage(
      1,
      LicenseRequest.ContentIdentification.CENC.write,
      obj.cenc_id
    );
  if (obj.webm_id)
    pbf.writeMessage(
      2,
      LicenseRequest.ContentIdentification.WebM.write,
      obj.webm_id
    );
  if (obj.license)
    pbf.writeMessage(
      3,
      LicenseRequest.ContentIdentification.ExistingLicense.write,
      obj.license
    );
};
...
LicenseRequest.ContentIdentification.CENC.read = function (pbf, end) {
  return pbf.readFields(
    LicenseRequest.ContentIdentification.CENC._readField,
    { pssh: [], license_type: 0, request_id: null },
    end
  );
};
LicenseRequest.ContentIdentification.CENC._readField = function (
  tag,
  obj,
  pbf
) {
...
LicenseRequest.ContentIdentification.CENC.write = function (obj, pbf) {
  if (obj.pssh)
    for (var i = 0; i < obj.pssh.length; i++)
      pbf.writeBytesField(1, obj.pssh[i]);
...
LicenseRequest.ContentIdentification.WebM.read = function (pbf, end) {
  return pbf.readFields(
    LicenseRequest.ContentIdentification.WebM._readField,
    { header: null, license_type: 0, request_id: null },
    end
  );
};
LicenseRequest.ContentIdentification.WebM._readField = function (
  tag,
  obj,
  pbf
) {
...
LicenseRequest.ContentIdentification.ExistingLicense.read = function (
  pbf,
  end
) {
  return pbf.readFields(
    LicenseRequest.ContentIdentification.ExistingLicense._readField,
    {
      license_id: null,
      seconds_since_started: 0,
      seconds_since_last_played: 0,
      session_usage_table_entry: null,
    },
    end
  );
};
LicenseRequest.ContentIdentification.ExistingLicense._readField = function (
  tag,
  obj,
  pbf
) {
  if (tag === 1)
    obj.license_id = LicenseIdentification.read(
      pbf,
      pbf.readVarint() + pbf.pos
    );
...
LicenseRequest.ContentIdentification.ExistingLicense.write = function (
  obj,
  pbf
) {
  if (obj.license_id)
    pbf.writeMessage(1, LicenseIdentification.write, obj.license_id);
  if (obj.seconds_since_started)
    pbf.writeVarintField(2, obj.seconds_since_started);
  if (obj.seconds_since_last_played)
    pbf.writeVarintField(3, obj.seconds_since_last_played);
  if (obj.session_usage_table_entry)
    pbf.writeBytesField(4, obj.session_usage_table_entry);
};
...
RemoteAttestation.read = function (pbf, end) {
  return pbf.readFields(
    RemoteAttestation._readField,
    { certificate: null, salt: null, signature: null },
    end
  );
};
RemoteAttestation._readField = function (tag, obj, pbf) {
  if (tag === 1)
    obj.certificate = EncryptedClientIdentification.read(
      pbf,
      pbf.readVarint() + pbf.pos
    );
...
RemoteAttestation.write = function (obj, pbf) {
  if (obj.certificate)
    pbf.writeMessage(1, EncryptedClientIdentification.write, obj.certificate);
...
SignedMessage._readField = function (tag, obj, pbf) {
  if (tag === 1) obj.type = pbf.readVarint();
    ...
    obj.remote_attestation = RemoteAttestation.read(
      pbf,
      pbf.readVarint() + pbf.pos
    );
};
SignedMessage.write = function (obj, pbf) {
  ...
  if (obj.remote_attestation)
    pbf.writeMessage(5, RemoteAttestation.write, obj.remote_attestation);
};
...
ProvisioningOptions.read = function (pbf, end) {
  return pbf.readFields(
    ProvisioningOptions._readField,
    { certificate_type: 0, certificate_authority: "" },
    end
  );
};
...
ProvisioningOptions.write = function (obj, pbf) {
  ...
  if (obj.certificate_authority)
    pbf.writeStringField(2, obj.certificate_authority);
};
...
ProvisioningRequest.read = function (pbf, end) {
  return pbf.readFields(
    ProvisioningRequest._readField,
    { client_id: null, nonce: null, options: null, stable_id: null },
    end
  );
};
ProvisioningRequest._readField = function (tag, obj, pbf) {
  if (tag === 1)
    ...
    obj.options = ProvisioningOptions.read(pbf, pbf.readVarint() + pbf.pos);
...
ProvisioningResponse.read = function (pbf, end) {
  return pbf.readFields(
    ProvisioningResponse._readField,
    {
      device_rsa_key: null,
      device_rsa_key_iv: null,
      device_certificate: null,
      nonce: null,
    },
    end
  );
...
SignedProvisioningMessage.read = function (pbf, end) {
  return pbf.readFields(
    SignedProvisioningMessage._readField,
...
ClientIdentification.read = function (pbf, end) {
  return pbf.readFields(
    ClientIdentification._readField,
    {
      type: { value: 0, options: {} },
      token: null,
      client_info: [],
      provider_client_token: null,
      license_counter: 0,
...
ClientIdentification._readField = function (tag, obj, pbf) {
  if (tag === 1) obj.type = pbf.readVarint();
    ...
    obj.client_info.push(
      ClientIdentification.NameValue.read(pbf, pbf.readVarint() + pbf.pos)
    );
  else if (tag === 4) obj.provider_client_token = pbf.readBytes();
  else if (tag === 5) obj.license_counter = pbf.readVarint();
  else if (tag === 6)
    obj.client_capabilities = ClientIdentification.ClientCapabilities.read(
      pbf,
      pbf.readVarint() + pbf.pos
    );
};
ClientIdentification.write = function (obj, pbf) {
  if (obj.type != undefined && obj.type !== { value: 0, options: {} })
    pbf.writeVarintField(1, obj.type);
  if (obj.token) pbf.writeBytesField(2, obj.token);
  if (obj.client_info)
    for (var i = 0; i < obj.client_info.length; i++)
      pbf.writeMessage(
        3,
        ClientIdentification.NameValue.write,
        obj.client_info[i]
      );
  if (obj.provider_client_token)
    pbf.writeBytesField(4, obj.provider_client_token);
  if (obj.license_counter) pbf.writeVarintField(5, obj.license_counter);
  if (obj.client_capabilities)
    pbf.writeMessage(
      6,
      ClientIdentification.ClientCapabilities.write,
      obj.client_capabilities
    );
};
...
ClientIdentification.NameValue.read = function (pbf, end) {
  return pbf.readFields(
    ClientIdentification.NameValue._readField,
    { name: "", value: "" },
    end
  );
};
...
ClientIdentification.ClientCapabilities.read = function (pbf, end) {
  return pbf.readFields(
    ClientIdentification.ClientCapabilities._readField,
    {
      client_token: false,
      session_token: false,
      video_resolution_constraints: false,
      max_hdcp_version: { value: 0, options: {} },
...
ClientIdentification.ClientCapabilities.write = function (obj, pbf) {
  ...
  if (obj.video_resolution_constraints)
    pbf.writeBooleanField(3, obj.video_resolution_constraints);
  if (
    obj.max_hdcp_version != undefined &&
    obj.max_hdcp_version !== { value: 0, options: {} }
  )
    pbf.writeVarintField(4, obj.max_hdcp_version);
  if (obj.oem_crypto_api_version)
    pbf.writeVarintField(5, obj.oem_crypto_api_version);
  if (obj.anti_rollback_usage_table)
...
EncryptedClientIdentification.read = function (pbf, end) {
  return pbf.readFields(
    EncryptedClientIdentification._readField,
    {
      service_id: "",
      service_certificate_serial_number: null,
      encrypted_client_id: null,
      encrypted_client_id_iv: null,
      encrypted_privacy_key: null,
    },
    end
  );
};
...
EncryptedClientIdentification.write = function (obj, pbf) {
  ...
  if (obj.service_certificate_serial_number)
    pbf.writeBytesField(2, obj.service_certificate_serial_number);
  if (obj.encrypted_client_id) pbf.writeBytesField(3, obj.encrypted_client_id);
  if (obj.encrypted_client_id_iv)
    pbf.writeBytesField(4, obj.encrypted_client_id_iv);
  if (obj.encrypted_privacy_key)
    pbf.writeBytesField(5, obj.encrypted_privacy_key);
};
...
DeviceCertificate.write = function (obj, pbf) {
  ...
  if (obj.creation_time_seconds)
    pbf.writeVarintField(3, obj.creation_time_seconds);
  if (obj.public_key) pbf.writeBytesField(4, obj.public_key);
  if (obj.system_id) pbf.writeVarintField(5, obj.system_id);
  if (obj.test_device_deprecated)
    pbf.writeBooleanField(6, obj.test_device_deprecated);
...
SignedDeviceCertificate.read = function (pbf, end) {
  return pbf.readFields(
    SignedDeviceCertificate._readField,
    { device_certificate: null, signature: null, signer: null },
    end
  );
};
SignedDeviceCertificate._readField = function (tag, obj, pbf) {
  if (tag === 1) obj.device_certificate = pbf.readBytes();
    ...
    obj.signer = SignedDeviceCertificate.read(pbf, pbf.readVarint() + pbf.pos);
};
...
ProvisionedDeviceInfo.read = function (pbf, end) {
  return pbf.readFields(
    ProvisionedDeviceInfo._readField,
    {
      system_id: 0,
      soc: "",
      manufacturer: "",
      ...
      device_type: "",
      model_year: 0,
      security_level: { value: 0, options: {} },
      test_device: false,
    },
    end
  );
...
ProvisionedDeviceInfo.write = function (obj, pbf) {
  ...
  if (
    obj.security_level != undefined &&
    obj.security_level !== { value: 0, options: {} }
  )
    pbf.writeVarintField(7, obj.security_level);
...
DeviceCertificateStatus.read = function (pbf, end) {
  return pbf.readFields(
    DeviceCertificateStatus._readField,
    {
      serial_number: null,
      status: { value: 0, options: {} },
      device_info: null,
    },
    end
  );
...
DeviceCertificateStatus._readField = function (tag, obj, pbf) {
  if (tag === 1) obj.serial_number = pbf.readBytes();
    ...
    obj.device_info = ProvisionedDeviceInfo.read(
      pbf,
      pbf.readVarint() + pbf.pos
    );
};
DeviceCertificateStatus.write = function (obj, pbf) {
  ...
  if (obj.status != undefined && obj.status !== { value: 0, options: {} })
    pbf.writeVarintField(2, obj.status);
  if (obj.device_info)
    pbf.writeMessage(4, ProvisionedDeviceInfo.write, obj.device_info);
};
...
DeviceCertificateStatusList.read = function (pbf, end) {
  return pbf.readFields(
    DeviceCertificateStatusList._readField,
    { creation_time_seconds: 0, certificate_status: [] },
    end
  );
};
DeviceCertificateStatusList._readField = function (tag, obj, pbf) {
  if (tag === 1) obj.creation_time_seconds = pbf.readVarint();
    ...
    obj.certificate_status.push(
      DeviceCertificateStatus.read(pbf, pbf.readVarint() + pbf.pos)
    );
};
DeviceCertificateStatusList.write = function (obj, pbf) {
  if (obj.creation_time_seconds)
    pbf.writeVarintField(1, obj.creation_time_seconds);
  if (obj.certificate_status)
    for (var i = 0; i < obj.certificate_status.length; i++)
      pbf.writeMessage(
        2,
        DeviceCertificateStatus.write,
        obj.certificate_status[i]
      );
};
...
SignedCertificateStatusList.read = function (pbf, end) {
  return pbf.readFields(
    SignedCertificateStatusList._readField,
    { certificate_status_list: null, signature: null },
    end
  );
};
...
SignedCertificateStatusList.write = function (obj, pbf) {
  if (obj.certificate_status_list)
    pbf.writeBytesField(1, obj.certificate_status_list);
  if (obj.signature) pbf.writeBytesField(2, obj.signature);
};
